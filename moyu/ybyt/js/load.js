...
$(document).ready(function(){
	...
	$("#btn_play").one("click",function(){
		...
		var writehtml='<object class id="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="/download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="'+w+'" height="'+h+'">'
			writehtml+='<param name="movie" value="flash/Flvplayer.swf"/*tpa=/js/flash/Flvplayer.swf*/>'
			...
			writehtml+='<embed src="flash/Flvplayer.swf"/*tpa=/js/flash/Flvplayer.swf*/ wmode="Opaque" allowfullscreen="true" flashvars="vcastr_file='+videourl+'&IsAutoPlay='+autoplay+'" quality="high" pluginspage="/www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="'+w+'" height="'+h+'"></embed>'
			writehtml+='</object>'
...
$.fn.css3_nthchild2=function(obj,objlist){
	...
	$.each(objlist,function(index,value){
		...
		{
		  max_width=parseInt(objs.set_width.split("/")[0])
